 ...
 * @version    $Id$
 */
class Landing_IndexController extends Zend_Controller_Action {

    public function init() {
        $this->_helper->acl->allow(null);
                Zend_Layout::startMvc(array(
                    'layoutPath' => APPLICATION_PATH . '/modules/landing/views/layouts',
                    'layout' => 'public'
                ));
    }
    ...
    public function indexAction() {
     //  echo 'test';die;
    	...
    	$src = $baseUrl . '/images/Logo_300_dpi.jpg';
    	$image1 = $baseUrl . '/images/2.jpg';
    	$image2 = $baseUrl . '/images/IMG_1522.jpg';
       $this->view->logo = $src;
       $this->view->image1 = $image1;
       $this->view->image2 = $image2;
            ...
            if ($form->isValid($this->getRequest()->getPost())) {
                ...
                if ($auth->authenticate($authAdapter)->isValid()) {
                    ...
                    $this->view->formResponse =
                            'Please try again or contact us at the bottom of the page ';
                }
            } else {
                Zend_Auth::getInstance()->clearIdentity();
                $this->view->formResponseTitle = 'Wrong e-mail or password';
                $this->view->formResponse =
                        'Please try again or contact us at the bottom of the page ';
            }
        }
