...
class Subscriber_ProgrammingController extends HandsOn_Controller_Action {
    ...
    public function indexAction() {
        $columns = array(
            ...
            'nr_descriptions' => array('Brief', 70),
            ...
            foreach ($programmingList as $eaProgr) {
                switch ($eaProgr['in_repetition']) {
                    case 0:
                        ...
                        break;
                    case 1:
                        $eaProgr['in_repetition'] = 'Fixed';
                        break;
                    case 2:
                        $eaProgr['in_repetition'] = 'Com interrupção';
                        break;
                }
                if ($eaProgr['in_repetition'] == 'Fixed') {
                    switch ($eaProgr['in_frequency']) {
                        case 1:
                            $eaProgr['in_frequency'] = 'Daily';
                            break;
                        case 2:
                            $eaProgr['in_frequency'] = 'Weekly';
                            break;
                        case 3:
                            $eaProgr['in_frequency'] = 'Monthly';
                            break;
                        case 4:
                            $eaProgr['in_repetition'] = 'Yearly';
                            break;
                    }
                } else {
...
error_log(var_export($historyAll, true));
    ...
    private function translateHistoryData(&$historyItem) {
        switch ($historyItem['in_repetition']) {
            case 0:
                ...
                break;
            case 1:
                $historyItem['in_repetition'] = 'Fixed';
                break;
            case 2:
                $historyItem['in_repetition'] = 'Com interrupção';
                break;
        }
        if ($historyItem['in_repetition'] == 'Fixed') {
            switch ($historyItem['in_frequency']) {
                case 1:
                    $historyItem['in_repetition'] = 'Daily';
                    break;
                case 2:
                    $historyItem['in_repetition'] = 'Weekly';
                    break;
                case 3:
                    $historyItem['in_repetition'] = 'Monthly';
                    break;
                case 4:
                    $historyItem['in_repetition'] = 'Yearly';
                    break;
            }
        } else {
    ...
    public function historypdfAction() {
        ...
        foreach ($accoutProgrammings as $v) {
            ...
            switch ($v['in_repetition']) {
                case 0:
                    ...
                    break;
                case 1:
                    $v['in_repetition'] = 'Fixed';
                    break;
                case 2:
                    $v['in_repetition'] = 'Com interrupção';
                    break;
            }
            if ($v['in_repetition'] == 'Fixed') {
                switch ($v['in_frequency']) {
                    case 1:
                        $v['in_repetition'] = 'Daily';
                        break;
                    case 2:
                        $v['in_repetition'] = 'Weekly';
                        break;
                    case 3:
                        $v['in_repetition'] = 'Monthly';
                        break;
                    case 4:
                        $v['in_repetition'] = 'Yearly';
                        break;
                }
            } else {
                $v['in_frequency'] = null;
        ...
        foreach ($tabelas as $key => $valores) {
            ...
            $page->drawText('Time', 265, $line3 + 20, 'UTF-8');
            $page->drawText('Options', 400, $line3 + 20, 'UTF-8');
